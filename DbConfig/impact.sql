...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 21, 2016 at 01:36 PM
...
INSERT INTO `user` (`id`, `name`, `email`, `city`, `country`, `description`, `picture`, `website`, `skype_id`, `yahoo_id`, `phone`, `address`, `username`, `password`, `time_entered`, `status`, `facebook_id`, `twitter_id`) VALUES
...
(1, 'home', 'Home', 'Welcome to Impact Training & Management Consulting', 'group, home'),

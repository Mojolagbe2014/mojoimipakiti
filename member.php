                    ...
                    <div class="content">
                        <article class="itemscope post_item post_item_single_team post_featured_right post_format_standard post-680 team type-team status-publish has-post-thumbnail hentry team_group-languages" itemscope itemtype="http://schema.org/Article">			
                            <section class="post_featured">
                                <div class="post_thumb" data-image="<?php echo $memberObj->picture; ?>" data-title="<?php echo $memberObj->name; ?>">
                                    <a class="hover_icon hover_icon_view" href="<?php echo $memberObj->picture; ?>" title="<?php echo $memberObj->name; ?>"><img class="wp-post-image" width="550" height="222" alt="<?php echo $memberObj->name; ?>" src="<?php echo $memberObj->picture; ?>" itemprop="image"></a>
                                </div>
                            </section>
                                ...
                                <div class="vc_row wpb_row vc_row-fluid">
                                    <div class="wpb_column vc_column_container vc_col-sm-5">
                                        <div class="wpb_wrapper">
                                            <h3 class="sc_title sc_title_iconed" style="margin-top:0px;margin-bottom:10px;">
                                                <span class="sc_title_icon sc_title_icon_top  sc_title_icon_small icon-book-2"></span>Biography
                                            </h3>
                                            <h4 class="sc_title sc_title_regular link_color" style="margin-bottom:0.8em;"><?php echo $memberObj->name; ?></h4>
                                            <div class="sc_section bg_tint_none" style="margin-bottom:1em !important;color:#222222;">

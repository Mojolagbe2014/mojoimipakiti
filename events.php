                                                        ...
                                                        <div class="column-1_3">
                                                            <div class="sc_team_item sc_team_item_1 odd first">
                                                                <div class="sc_team_item_avatar">
                                                                    <img class="wp-post-image" width="350" height="290" alt="<?php echo $eventObj->name; ?>" src="<?php echo $eventObj->image; ?>">
                                                                </div>
                                                                <div class="sc_team_item_info">
                                                                    ...
                                                                    <div class="sc_team_item_position">Location: <a target="_blank" href="https://www.google.com?q=<?php echo $eventObj->location; ?>"><?php echo $eventObj->location; ?></a></div>       
                                                                    <div class="sc_team_item_position">Date: <a href="javascript:;"><?php echo $eventObj->dateTime; ?></a></div>
                                                                    <div class="sc_team_item_position">
                                                                        <a href="<?php echo SITE_URL; ?>event/<?php echo $eventObj->id.'/'.StringManipulator::slugify($eventObj->name); ?>/" data-animation="animated fadeInUp normal" class="sc_button sc_button_square sc_button_style_filled sc_button_bg_menu sc_button_size_small aligncenter animated fadeInUp normal" style="margin-top:10px;margin-bottom:4px;">VIEW INFO</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>

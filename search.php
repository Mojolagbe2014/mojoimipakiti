                                ...
                                <div class="vc_row wpb_row vc_row-fluid">
                                    <div class="wpb_column vc_column_container vc_col-sm-12">
                                        <div class="wpb_wrapper">
                                            <div class="content-pad" style="margin-bottom:10px"><em>Below are the item(s) that match your search:</em> <strong style="color:green"><?php  echo $searchParam; ?></strong></div>
                                                ...
                                                <div class="sc_accordion sc_accordion_style_1" data-active="0">
                                                    ...
                                                    <div class="sc_accordion_item odd first">
                                                        <h5 class="sc_accordion_title">
                                                            <span class="sc_accordion_icon sc_accordion_icon_closed icon-plus-2"></span><span class="sc_accordion_icon sc_accordion_icon_opened icon-minus-2"></span><img class="wp-post-image" width="40" height="40" alt="<?php echo $courseObj->name; ?>" src="<?php echo $courseObj->image; ?>"> <?php echo $courseObj->name ?></h5>
                                                            <div class="sc_accordion_content">
                                                                <div class="wpb_text_column wpb_content_element ">
                                                                    <div class="wpb_wrapper">
                                                                        <p><?php echo StringManipulator::trimStringToFullWord(200, strip_tags($courseObj->description)); ?>..</p>
                                                                        <p>Date: <?php echo $courseObj->endDate; ?></p>
                                                                        <p><a href="<?php echo SITE_URL.'course/'.$courseObj->id.'/'.StringManipulator::slugify($courseObj->name).'/'; ?>">View Full Details</a></p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    </div>

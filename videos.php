                                        ...
                                        <div class="wpb_wrapper">
                                            <div class="sc_section" data-animation="animated fadeInUp normal">
                                                <div class="sc_accordion sc_accordion_style_1" data-active="0">
                                                    <?php 
                                                    foreach ($videoObj->fetchRaw("*", " 1 = 1 ", " name ASC ") as $video) {
                                                    ...
                                                    <div class="sc_accordion_item odd first">
                                                        <h5 class="sc_accordion_title">
                                                            <span class="sc_accordion_icon sc_accordion_icon_closed icon-plus-2"></span><span class="sc_accordion_icon sc_accordion_icon_opened icon-minus-2"></span> <?php echo $videoObj->name ?>
                                                        </h5>
                                                                ...
                                                                <div id="sc_tabs_890687350" class="sc_tabs sc_tabs_style_2" style="margin-top:3em;" data-active="2">
                                                                    <ul class="sc_tabs_titles">
                                                                        <li class="sc_tabs_title first">
                                                                            <a href="#sc_tab_1425369861162-10<?php echo $videoObj->id; ?>" class="theme_button" id="sc_tab_1425369861162-10<?php echo $videoObj->id; ?>_tab">Description</a>
                                                                        </li>
                                                                        <li class="sc_tabs_title">
                                                                            <a href="#sc_tab_1425369861559-7<?php echo $videoObj->id; ?>" class="theme_button" id="sc_tab_1425369861559-7<?php echo $videoObj->id; ?>_tab">Video</a>
                                                                        </li>
                                                                    </ul>
                                                                    <div id="sc_tab_1425369861162-10<?php echo $videoObj->id; ?>" class="sc_tabs_content odd first">
                                                                        <div id="sc_tab_1425369861162-10<?php echo $videoObj->id; ?>_scroll" class="sc_scroll sc_scroll_vertical" style="height:200px;">
                                                                            <div class="sc_scroll_wrapper swiper-wrapper">
                                                                                <div class="sc_scroll_slide swiper-slide">
                                                                                    <div class="wpb_text_column wpb_content_element ">
                                                                                        <div class="wpb_wrapper">
                                                                                            <p><?php echo $videoObj->description; ?></p>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div id="sc_tab_1425369861162-10<?php echo $videoObj->id."_scroll_bar"; ?>" class="sc_scroll_bar sc_scroll_bar_vertical sc_tab_1425369861162-10<?php echo $videoObj->id."_scroll_bar"; ?>"></div>
                                                                        </div>
                                                                    </div>
                                                                    <div id="sc_tab_1425369861559-7<?php echo $videoObj->id; ?>" class="sc_tabs_content even">
                                                                        <div id="sc_tab_1425369861559-7<?php echo $videoObj->id; ?>_scroll" class="sc_scroll sc_scroll_vertical">
                                                                            <div class="sc_scroll_wrapper swiper-wrapper">
                                                                                <div class="sc_scroll_slide swiper-slide">
                                                                                    <div class="wpb_text_column wpb_content_element ">
                                                                                        <div class="wpb_wrapper">
                                                                                            <video preload="metadata" controls><source src="<?php echo $videoObj->video; ?>" type="video/mp4"></video>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div id="sc_tab_1425369861559-7<?php echo $videoObj->id."_scroll_bar"; ?>" class="sc_scroll_bar sc_scroll_bar_vertical sc_tab_1425369861559-7<?php echo $videoObj->id."_scroll_bar"; ?>"></div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>

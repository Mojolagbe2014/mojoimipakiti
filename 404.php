...
<body class="error404 themerex_body body_style_wide body_filled theme_skin_education article_style_stretch layout_excerpt template_excerpt top_panel_style_light top_panel_opacity_solid top_panel_show top_panel_above menu_right user_menu_show sidebar_hide wpb-js-composer js-comp-ver-4.7.2 vc_responsive">
    <div class="body_wrap">
        <div class="page_wrap">
            <div class="top_panel_fixed_wrap"></div>
            <?php include('includes/header.php'); ?>
            
            <div class="page_content_wrap" style="background-image: url(<?php echo SITE_URL; ?>themes/education/skins/education/images/bg_over.png); background-repeat: repeat-x; background-position: center top;">
...
<div class="content">		<article class="post_item post_item_404">
			<div class="post_content">
				...
				<p class="page_description">Can't find what you need? Take a moment and do a search below or start from <a href="<?php echo SITE_URL; ?>">our homepage</a>.</p>
				<div class="page_search"><div class="search_wrap search_style_flat search_opened search_fixed search_ajax" title="Open/close search form">
					<a href="#" class="search_icon icon-search-2"></a>
					<div class="search_form_wrap">
						<form role="search" method="get" class="search_form" action="<?php echo SITE_URL; ?>search">
							
                                                    <input required="required" type="text" class="search_field" placeholder="To search type and hit enter" value="" name="s" title="To search type and hit enter" />
                                                        <button type="submit" class="" title="Start search">Search</button>
						</form>
					</div>
